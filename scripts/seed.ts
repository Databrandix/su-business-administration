...
const DEAN_MESSAGE_PARAGRAPHS = [
  'In today’s rapidly evolving global economy, business leadership demands more than just traditional knowledge—it requires agility, strategic foresight, technological adaptability, and strong ethical values. The <strong class="text-button-yellow">Faculty of Business</strong> is committed to serving as an incubator for forward-thinking leaders, entrepreneurs, and innovators who are prepared to drive impactful change across diverse sectors both nationally and internationally.',
  'Our faculty encompasses dynamic departments designed to offer a holistic, interdisciplinary education. Through robust curricula grounded in core business disciplines—including <strong class="text-button-yellow">Accounting, Finance, Marketing, Management, Human Resource Management, Supply Chain Management, Operations, MIS, and International Business</strong>—we equip our students with both broad strategic vision and specialized expertise. By integrating modern pedagogical frameworks, industry-aligned practices, and practical problem-solving, we ensure our graduates are fully equipped to meet the demands of future employment trends.',
  'Beyond academic excellence, we prioritize fostering a collaborative environment enriched by a distinguished faculty, cutting-edge research, and strong industry partnerships. We aim to cultivate critical thinking, cross-cultural competence, and effective leadership skills in every student who walks through our doors. Whether you aspire to lead corporate enterprises, pioneer innovative startups, or contribute to sustainable economic development, the Faculty of Business provides the foundation, network, and guidance to help you reach your highest potential. We invite you to join us on this transformative journey toward excellence.',
];
