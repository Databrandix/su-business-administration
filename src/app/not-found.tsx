...
import { Home, Search, ArrowLeft, TrendingUp, Briefcase } from 'lucide-react';
import Container from '@/components/ui/Container';

export const metadata = {
  title: 'Page Not Found',
  description:
    "The page you're looking for doesn't exist on the Department of Business Administration website.",
};
...
export default function NotFound() {
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden pt-[180px] md:pt-[200px] pb-20 bg-gray-50">
      ...
      {/* Business-school motifs rather than the engineering gears this
          page was originally built with. */}
      <TrendingUp
        className="absolute top-[12%] right-[8%] text-primary/[0.05] rotate-6 pointer-events-none hidden md:block"
        size={220}
        strokeWidth={1}
      />
      <Briefcase
        className="absolute bottom-[10%] left-[6%] text-accent/[0.05] -rotate-6 pointer-events-none hidden md:block"
        size={160}
        strokeWidth={1}
      />
