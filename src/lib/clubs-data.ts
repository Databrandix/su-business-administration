...
export const clubs: Club[] = [
  ...
  {
    id: 'sumec',
    name: 'Sonargaon University Business Club',
    abbreviation: 'SUBC',
    description:
      'Representing the Department of Business Administration, this club is highly active in technical fests. They recently gained recognition as a "Valuable Club Partner" at high-profile events like Auto Fest.',
