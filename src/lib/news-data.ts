...
export const news: NewsArticle[] = [
  {
    ...
    title:
      'SU Business Students Gain Practical Insights at Bangladesh Machine Tools Factory (BMTF)',
  ...
  },
  {
    slug: 'ifsse-2024',
    title:
      'SUBC Members Attend International Fire, Safety & Security Expo (IFSSE-2024)',
    shortTitle: 'SUBC at IFSSE-2024',
    category: 'Seminar',
    date: '17 Feb, 2024',
    isoDate: '2024-02-17',
    ...
    summary:
      'SUBC members joined the inaugural ceremony of the three-day International Fire, Safety & Security Expo at BICC, Dhaka.',
    body: [
      'Members of the Sonargaon University Business Club (SUBC) recently participated in the inaugural ceremony of the three-day long International Fire, Safety & Security Expo (IFSSE-2024). The prestigious event commenced on February 17, 2024, at the Bangabandhu International Conference Center (BICC) in the capital.',
      ...
      'Participation in such high-profile international expos is part of the Department of Business Administration’s ongoing commitment to exposing students to real-world industrial safety and security technologies. During the seminar, SUBC members had the opportunity to interact with industry leaders and explore the latest advancements in fire safety and security systems — subjects that are integral to their academic curriculum and future professional roles.',
  ...
  },
  {
    ...
    meta: [
      { label: 'Organising Partner', value: 'Sonargaon University Business Club (SUBC)' },
    ...
    body: [
      ...
      'Professor Md. Mostofa Hossain, Head of the Department of Business Administration, presided over the session as the Chairperson. Under his guidance, the Sonargaon University Business Club (SUBC) acted as the organising partner, ensuring a seamless experience for all participants.',
  ...
  },
  {
    ...
    title: 'SUBC Celebrates 1st Anniversary with Advanced Technical Workshops',
    shortTitle: 'SUBC 1st Anniversary Workshops',
    category: 'Workshop',
    date: '2024',
    isoDate: '2024-04-10',
    cover: '/assets/news/sumec-1st-anniversary.webp',
    meta: [
      { label: 'Organiser', value: 'Sonargaon University Business Club (SUBC)' },
      { label: 'Location', value: 'Business Administration Dept. Labs, SU' },
    ],
    summary:
      'On its 1st Foundation Anniversary, SUBC launched two specialised workshops — 3D Printing and 4-Stroke Engine Assembly.',
    body: [
      'On the auspicious occasion of the 1st Foundation Anniversary of Sonargaon University Business Club (SUBC), the Department of Business Administration organised a day of technical empowerment for its students. The celebration was marked by the launch of two specialised workshops aimed at bridging the gap between theoretical study and industry-standard practical skills.',
      'The event was officially inaugurated by Prof. Md. Mostofa Hossain, Head of the Department of Business Administration. To foster a culture of hands-on learning, the department introduced two high-impact training sessions — a 3D Printing Training Session and a 4-Stroke Engine Assembly and Disassembly workshop, giving students direct exposure to rapid prototyping and automotive technology.',
      'In his keynote address, Prof. Mostofa Hossain highlighted the critical importance of practical knowledge in the modern engineering landscape. He emphasised that the Department of Business Administration has always prioritised a "learning-by-doing" approach. "Engineering education is incomplete without technical mastery," he stated, expressing his firm belief that through such initiatives, SU students will eventually establish themselves as world-class, quality engineers on the global stage.',
      'The workshops saw enthusiastic participation from students across various semesters, reflecting the department’s commitment to creating a transformative learning experience. These initiatives continue to solidify the reputation of the Department of Business Administration as a leader in technical excellence at Sonargaon University.',
    ],
  },
  {
    ...
    summary:
      'Business Administration students completed a month-long industrial training programme at TICI — the department’s first such achievement.',
    body: [
      'Sonargaon University (SU) recently marked a significant achievement as students from the Department of Business Administration successfully completed a comprehensive industrial training programme at the prestigious Training Institute for Chemical Industries (TICI) in Ghorashal, Narshingdi.',
      'This programme represents a historic moment for the department, as it is the first time our Business Administration students have completed their industrial training at this esteemed government institute. The month-long intensive programme was designed to bridge the gap between academic theory and industrial practice, providing students with hands-on exposure to high-level engineering environments.',
      'The training covered an extensive range of technical subjects essential for modern business professionals.',
